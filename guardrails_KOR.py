...
# 구성 파일 로드
def load_guardrail_config(config_file="guardrail_config_KOR.json"):
    """
    가드레일 구성 파일을 로드합니다.
...
def create_dynamic_guardrail(
    ...
    config_file="guardrail_config_KOR.json",
    region=AWS_REGION
):
    """
...
# 사용 가능한 역할 목록 가져오기
def get_available_roles(config_file="guardrail_config_KOR.json"):
    """
